# Blog: https://fronkonstin.com/2019/01/10/rcpp-camaron-de-la-isla-and-the-beauty-of-maths/
# Github: https://github.com/aschinchon/general-2D-map
library(Rcpp)
library(tidyverse)
...
plot <- ggplot(df) +
  geom_point(aes(x, y, color = x), shape=46, alpha=0.01, size=0) +
